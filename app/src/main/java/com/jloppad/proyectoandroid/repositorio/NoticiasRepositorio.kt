...
class NoticiasRepositorio {
    suspend fun obtenerNoticias(claveApi: String, nuevaBusqueda: String, ordenar: String): RespuestaNoticias {
        return RetrofitInstancia.api.obtenerNoticias(claveApi = claveApi, busqueda = nuevaBusqueda, ordenar = ordenar)
    }
}
